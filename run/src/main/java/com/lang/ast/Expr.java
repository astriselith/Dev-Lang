...
public abstract class Expr extends Node {
	...
	public <T> T accept(ExprVisitor<T> visitor) {
		...
		if (this instanceof RefExpr)
			return visitor.visitRefExpr((RefExpr) this);
		...
		if (this instanceof IndexAccessExpr)
			return visitor.visitIndexAccessExpr((IndexAccessExpr) this);
		if (this instanceof MemberAccessExpr)
			return visitor.visitMemberAccessExpr((MemberAccessExpr) this);
