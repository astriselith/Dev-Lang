package com.dev.lang.util.buffer;

import java.util.Arrays;

public abstract class StreamBuffer<T> {
	...
	protected StreamBuffer(int forwardWindow, int backwardWindow, int capacityMultiplier) {
