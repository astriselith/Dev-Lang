...
import com.dev.lang.symbol.SymbolTable;
import com.dev.lang.tools.Printer;
...
import com.dev.lang.module.Module;
import com.dev.lang.module.Modules;
	...
	private static void handleModuleAdd(String modulePath) {
		try {
			...
			if (!path.toString().endsWith(".module")) {
				System.err.println("Arquivo deve ter extensão .module");
				return;
			}
	...
	private static void processFile(String path) {
		try {
			...
			if (!input.toString().endsWith(".lang")) {
				System.err.println("Arquivo deve ter extensão .lang");
				return;
			}
